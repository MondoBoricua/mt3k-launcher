...
MT3K Launcher, like ORBIT, integrates the proprietary Discord Social SDK. The SDK and
its `discord_partner_sdk.dll` library are not part of the GPL-licensed source
...
The MT3K Launcher Windows installer contains the SDK only as an integrated
