...
import { scanCaptureDirectory, validateCaptureFile } from './captureFiles'
...
export async function resolveCaptureImage(url: string): Promise<string | null> {
  ...
  try { return await validatedFile(candidate) }
